%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\iconsection{opensource}{Open source projects}{\faLockOpen}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\projectsubsection{creativecommons}% Keyword
...
\projectsubsection{omniportback}% Keyword
...
\ifdocoriented
\projectsubsection{omniportdocs}% Keyword
...
\else
\projectsubsection{omniportinfra}% Keyword
