%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\colouredsection{Open source}{Open source}{orange}{\fasLockOpen}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\worksubsection{Vocabulary}% Keyword
...
\sectiondescription{
  ...
  \begin{itemize}[nosep, leftmargin=*]
    ...
    \item Deployed all these products to GitHub Pages and \href{https://cc-vocabulary.netlify.com}{Netlify}.
    \item Identified easy issues to encourage beginner contributors.
    \item Published the library to \href{https://www.npmjs.com/package/@creativecommons/vocabulary}{npm}, jsDelivr and unpkg.
  \end{itemize}
}


\worksubsection{Omniport backend}% Keyword
...
\ifdocoriented
\worksubsection{Omniport documentation}% Keyword
...
\else
\worksubsection{Omniport infrastructure}% Keyword
